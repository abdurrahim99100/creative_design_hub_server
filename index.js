...
async function run() {
  try {
    ...
    const usersCollection = client.db("dance-club-db").collection("users");
...
app.get('/', (req, res) => {
  res.send('DANCE CLUB BD SERVER IS RUNNING ....................ON:P(5000)')
})

app.listen(port, () => {
  console.log(`DANCE CLUB BD SERVER IS RUNNING ON PORT ${port}`);
})